...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>2024 General Election of Ghana</title>
        ...
        <div id="app">
            <v-app v-cloak>
                ...
                <v-app-bar flat class="pl-16 pr-16">
                    <v-app-bar-title v-if="!$vuetify.display.mobile">2024 General Election of Ghana</v-app-bar-title>
                ...
                <v-bottom-navigation
                    ...
                    active
                >
                    <v-btn to="/sissala-east">
                        Sissala East
                    </v-btn>

                    <v-btn to="/sissala-west">
                        Sissala West
                    </v-btn>
                </v-bottom-navigation>
            </v-app>
